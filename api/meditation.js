...
- Estrés / agitación mental: exhalación ligeramente más larga que la inhalación como primer gesto (efecto calmante inmediato). Metáfora del árbol: parte alta del cuerpo (cabeza, cuello, hombros) = copa agitada por el viento y la tormenta; parte baja (abdomen, pelvis, piernas) = tronco y raíces que no se rompen. Mover la atención desde la copa hacia la base. Respiración abdominal como ancla física en esa base estable. Repetir la metáfora en distintas fases: "ya no estás en la copa — estás en la base, firme, silencioso".
- Sobrepensamiento / rumiación: salir de la cabeza hacia el cuerpo. Anclaje sensorial (luz, sonidos, temperatura en la piel) como primer paso antes de la respiración. Body scan descendente. Nombrar sensaciones sin interpretarlas. No intentar resolver nada — solo observar sin engancharse. Normalizar la distracción explícitamente: "tu mente se distraerá — cuando lo haga, simplemente vuelve".
...
- Insomnio / preparar el sueño: tres ciclos de respiración dirigidos en secuencia — primero al cuerpo (liberar tensión física), luego a la mente (liberar pensamientos), luego a las emociones (soltar intensidad emocional). Entre ciclos: gratitud breve a cada nivel ("agradece a tu cuerpo todo lo que hizo hoy por ti", "agradece a tu mente su esfuerzo"). Fase 4: permiso total — "nada que hacer, nada que pensar, nada que sentir". Cierre con autocompasión: reconocer méritos del día, perdonar errores, darse permiso de descansar para dar lo mejor mañana. Nunca decir "duérmete" — solo invitar al descanso sin objetivo.
...
- Tensión corporal: escaneo y liberación progresiva. Empezar desde los puntos de tensión específicos que mencionó el usuario.
...
- Repetición intencional: una metáfora o imagen central (ej: "crear espacio", "ola de calma", "la base del árbol") se introduce en Fase 2 y se repite en variaciones en Fases 3 y 4 — la repetición ancla, no aburre.
- La exhalación tiene función activa: exhalar puede expandir, enviar, transformar, liberar hacia afuera — darle propósito hace la práctica más vívida que simplemente "soltar".
- Anclaje sensorial como apertura alternativa: antes de ir a la respiración, invitar a notar la luz, los sonidos o la temperatura en la piel — trae al presente de forma concreta y suave.
- Normalizar la distracción: "tu mente se distraerá — cuando lo haga, simplemente vuelve" — reduce la frustración del usuario y hace la práctica más accesible.
- Frases de permiso total para Fase 4: "no hay nada que hacer, ningún lugar al que ir, nada que pensar" — especialmente efectivas cuando el usuario llega agotado o sobrepensando.
- La respiración como ancla: "tu respiración te conecta al momento presente" — puede usarse como recordatorio puntual durante el arco sin resultar repetitivo.
